                ...
                <div className="relative">
                  <input
                    ...
                    value={
                      ...
                      location.address || 
                      (location.latitude ? `${location.latitude.toFixed(6)}, ${location.longitude.toFixed(6)}` : 'Click to detect location')
                    }
                    className="w-full border border-gray-300 rounded px-3 py-2 pr-10 text-xs focus:ring-1 focus:ring-teal-500"
                    readOnly
                  />
                  <button
                    type="button"
                    ...
                    className={`absolute right-0 top-0 h-full flex items-center justify-center w-20 ${
                      isDetectingLocation || isVerifyingLocation ? 'bg-gray-400 cursor-not-allowed' : 'bg-teal-500 hover:bg-teal-600'
                    } text-white rounded-r text-xs`}
                  >
                    <span className="icon-map mr-1"></span> Detect
                  </button>
                </div>
              </div>
